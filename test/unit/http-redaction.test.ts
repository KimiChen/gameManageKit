...
test("结构化日志覆盖所有业务 Secret 字段名", async (t) => {
  ...
  const secrets = {
    ...
    douyinAppSecret: "value-douyin-secret",
    douyin_app_secret: "value-douyin-snake-secret",
    code: "value-one-time-code",
    sessionKey: "value-session-key",
    session_key: "value-session-snake-key",
    openid: "value-openid",
    unionid: "value-unionid",
    subject: "value-normalized-subject",
    unionSubject: "value-normalized-union-subject",
