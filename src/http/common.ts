    ...
    ? {
        redact: {
          paths: [
            ...
            "req.body.douyinAppSecret",
            "request.body.douyinAppSecret",
            "req.body.douyin_app_secret",
            "request.body.douyin_app_secret",
            "req.body.code",
            "request.body.code",
            "req.body.sessionKey",
            "request.body.sessionKey",
            "req.body.session_key",
            "request.body.session_key",
            "req.body.openid",
            "request.body.openid",
            "req.body.unionid",
            ...
            "req.body.unionSubject",
            "request.body.unionSubject",
